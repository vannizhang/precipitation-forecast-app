...
require([
    ...
    map.on("click", function(evt) {
        if (!$('#draw-layer').hasClass('active')) {
            ...
            app.queryAppData.startup({
                mapEventGeom: evt.mapPoint
            }).then(function(d) {
                generateChart(d);
            });
        }
    ...
    generateChart = function(inputData) {
        ...
        uniqueTimeValuesForDomain.push(+app.getSixHourTimeInterval(uniqueTimeValuesForDomain[uniqueTimeValuesForDomain.length - 1], true)[1]);
        ...
        function populateChartElements() {
            ...
            var xAxis = d3.svg.axis()
                ...
                .tickFormat(function(d) {
                    return app.getSimplifiedDate(d, true, {
                        "chart-tick": true
                    });
                });
            ...
            var periodBar = svg.selectAll(".period-bar")
                ...
                .attr("x", function(d) {
                    return xScale(d) + xScaleOffset;
                })
                .attr("width", xScaleOffset * 2)
                .attr("y", function(d) {
                    return yScale(maxYValue);
                })
            ...
            d3.select("#x-axis").selectAll(".tick").attr("id", function(d, i) {
                return "axis-" + i
            });
            ...
            var area = d3.svg.area()
                .x(function(d) {
                    return xScale(d.fromTime) + xScaleOffset * 2;
                })
                .y0(function(d) {
                    return yScale(d.amountLow);
                }) //lower
                .y1(function(d) {
                    return yScale(d.amountHigh);
                }); //higher
